    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "NVidia Science Mouse", 267.57m, 1m },
                    { 2, "Samsung Business Mouse", 223.18m, 8m },
                    { 3, "Intel Business Processor", 591.32m, 8m },
                    { 4, "NVidia Business Processor", 354.38m, 4m },
                    { 5, "Cooler Master Gaming Keyboard", 115.03m, 10m },
