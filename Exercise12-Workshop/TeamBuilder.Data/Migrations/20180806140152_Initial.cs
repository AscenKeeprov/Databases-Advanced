        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Acronym = table.Column<string>(unicode: false, fixedLength: true, maxLength: 3, nullable: false),
                    IsDisbanded = table.Column<bool>(nullable: false),
                    CreatorId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teams_Name_Acronym_Id",
                table: "Teams",
                columns: new[] { "Name", "Acronym", "Id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Users_Username_Id",
                table: "Users",
